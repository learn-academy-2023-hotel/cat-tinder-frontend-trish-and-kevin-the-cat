const mockCats = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1572897263855-ea51655f9f0b?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    user_id: 1,
  },
  {
    id: 2,
    name: "Geppetto",
    age: 14,
    enjoys: "sleep on my pillow next to my head",
    image:
